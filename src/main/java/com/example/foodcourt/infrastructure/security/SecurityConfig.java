...
import static com.example.foodcourt.domain.utils.constant.Constants.ROLE_ADMIN;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/restaurant/**","/home/**","/orders/**","/dish").permitAll()
                        .requestMatchers(HttpMethod.POST, "/dish/**", "/restaurant-employee/**").hasAuthority(ROLE_OWNER)
